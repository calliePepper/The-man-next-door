module.exports = {
    ...
    feedObjects: {
	    ...
	    9:{postId:9,fromId:1,date:840,text:'They call me Sam, I don\'t know wat. I call me Sam too. (Sent at 2pm)',image:'',video:'',likes:4,comments:0},
	    ...
	    13:{postId:13,fromId:1,date:1080,text:'I\'ll fix it, I\'m good at fixing rot. Call me the Rotmeister. Actually call me Sam. Never call me the Rotmeister (Sent at 6pm)',image:'',video:'',likes:4,comments:0},
    ...
    commentObjects: {
        1:{
            comments:[
                {order:1,user:2,date:540,text:'You are such a rebel Sam',image:'',video:'',likes:2},
        ...
        2:{
            comments:[
                {order:1,user:2,date:601,text:'You are such a rebel Sam',image:'',video:'',likes:2},
        ...
        3:{
            comments:[
                {order:1,user:2,date:603,text:': Grins like an idiot :',image:'',video:'',likes:5}    
            ],
            autoTarget: 'choice',
            autoId:'4'
        }
    ...
    messageObjects: {
        ...
        2:{
            messages:[
                ...
                {msgId:'2_2',fromId:2,toId:2,timestamp:1444973705,message:'I think Sam is totally getting carried away with this whole \'neighbour\' situation',image:'',video:'',from:1},
    ...
    choiceObjects: {
        ...
        2: {choiceId:2,choice1:'Sam, you are an embarrasment',choice2:'How do you deal with this Cal?',choice3:'Yeah! Fight the power!',resultType:'comment',result1:3,result2:3,result3:3,ttd:''},
